...
namespace DataAccess
{
    ...
    public partial class DailyInvRecap
    {
        public int AutoID { get; set; }
        public System.DateTime RecapDate { get; set; }
        public int InventoryItemID { get; set; }
        public Nullable<float> EndingQty { get; set; }
        public Nullable<float> EndingValue { get; set; }
        public Nullable<float> ReceivedQty { get; set; }
        public Nullable<float> ReceivedValue { get; set; }
