...
namespace DataAccess
{
    ...
    public partial class MenuModifierPopUp
    {
        public int ModifierPopUpID { get; set; }
        public int MenuItemID { get; set; }
        public int MenuModifierID { get; set; }
        public int PopUpSequenceOrder { get; set; }
        ...
        public virtual MenuModifier MenuModifier { get; set; }
    }
}
