...
namespace DataAccess
{
    ...
    public partial class tmpOrderTransaction
    {
        ...
        public Nullable<float> MenuItemUnitPrice { get; set; }
        public Nullable<float> Quantity { get; set; }
        public Nullable<float> ExtendedPrice { get; set; }
        public Nullable<int> DiscountID { get; set; }
        public Nullable<float> DiscountAmount { get; set; }
        public string DiscountBasis { get; set; }
        public Nullable<bool> DiscountTaxable { get; set; }
